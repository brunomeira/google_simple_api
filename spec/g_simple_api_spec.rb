...
describe GSimpleApi do
  ...
  describe "Methods" do
    describe ".setup" do
      it { GSimpleApi.should respond_to :setup }

      it "creates a valid instance of GSimpleApi::Setting" do
        setup_call
        GSimpleApi.settings.class.should == GSimpleApi::Settings
      ...
      it "loads api" do
        GSimpleApi.settings.should_receive(:load_api).once
        setup_call
      end
    ...
    describe ".process" do
      it { GSimpleApi.should respond_to :process }
      it { GSimpleApi.process.should be_a GSimpleApi::Manager }
    end
  end
  ...
  describe "full flow" do
    ...
    it "creates an authorization URL" do
      setup_call
      GSimpleApi.process.authorize_url(authorization_url).should be_a String
    end
  end
